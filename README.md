...
This also resembles how the associated Google Cloud Build [pipeline](#build-and-coverage-pipelines)
runs in [Docker][maven-docker].
...
So, you may need to adjust that, and replace **2021.0209.0355** below with the latest released version of
...
<dependencyManagement>
    <dependencies>
        <dependency>
            ...
            <version>2021.0209.0355</version>
        </dependency>
        <dependency>
            <groupId>hoot-smalltalk</groupId>
